    ...
    <main className="home">
      <section className="home__section">
        ...
        <div className="home__movies-container">
          <GetMoviesSeries type="now_playing" region="FI" page={1} pages={3} imageSize="w185" />
        </div>
      </section>
      ...
      <section className="home__section">
        ...
        <div className="home__movies-container">
          <GetMoviesSeries type="top_rated" page={1} imageSize="w185" limit={10} />
        </div>
      </section>
      ...
      <section className="home__section">
        ...
        <div className="home__movies-container">
          <GetMoviesSeries type="top_rated" media_type="tv" page={1} imageSize="w185" limit={10} />
        </div>
      </section>
      ...
      <section className="home__section">
        ...
        <div className="home__movies-container">
          <GetMoviesSeries type="upcoming" page={1} pages={2} imageSize="w185" />
        </div>
      </section>
      ...
      <section className="home__section">
        ...
        <div className="home__movies-container">
          <GetMoviesSeries type="popular" page={1} pages={2} imageSize="w185" />
        </div>
      </section>
    </main>
  );
